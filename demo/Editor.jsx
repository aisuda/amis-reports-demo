...
import {fetcher, getPageQuery, updateCsrfToken, fetcherCsrfToken} from './common/utils';

// 导入报表组件渲染器列表
import 'amis-reports/lib/renderers';
import 'amis-reports/lib/renderers.css'; // 报表组件样式
// 导入报表组件插件列表
import reportPlugins, {chartArrayData, chartDefaultDimensions, chartDefaultMeasures} from 'amis-reports/lib/plugins';
    ...
    return (
      <div className="Editor-Demo">
        <div className="Editor-header">
          <div className="Editor-title">页面设计器</div>
